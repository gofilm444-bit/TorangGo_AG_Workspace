...
// Memory fallback for Node.js test environments where Expo native modules are not linked
...
export const customerSecureStorage = new MobileSecureStorage('toranggo_customer');
